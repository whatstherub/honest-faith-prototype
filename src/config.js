...
System.config({
  map: {
    ...
    "common.services.inventory": "js/common/services/inventory/inventory.module",

    "common.components.inventory.product_projection": "js/common/components/inventory/product_projection/product_projection.module",
    ...
    "common.components.inventory.inventory_projection_tweaks": "js/common/components/inventory/inventory_projection_tweaks/inventory_projection_tweaks.module",
    "common.components.inventory.at_risk_products": "js/common/components/inventory/at_risk_products/at_risk_products.module",
   ...
   "common.components.inventory.product_projection_summary.product_projection_summary_list.controller": "js/common/components/inventory/product_projection_summary/product_projection_summary_list.controller",
    ...
    "common.components.inventory.at_risk_products.at_risk_products_over_time.controller": "js/common/components/inventory/at_risk_products/at_risk_products_over_time.controller",
    "common.components.inventory.at_risk_products.at_risk_products_over_time.directive": "js/common/components/inventory/at_risk_products/at_risk_products_over_time.directive",
    ...
    "common.components.inventory.product_projection.product_projection.controller": "js/common/components/inventory/product_projection/product_projection.controller",
    "common.components.inventory.product_projection.product_projection.directive": "js/common/components/inventory/product_projection/product_projection.directive",

    "common.components.inventory.product_projection.product_projection_list.controller": "js/common/components/inventory/product_projection/product_projection_list.controller",
    "common.components.inventory.product_projection.product_projection_list.directive": "js/common/components/inventory/product_projection/product_projection_list.directive",

    "common.components.inventory.at_risk_products.at_risk_navigator.controller": "js/common/components/inventory/at_risk_products/at_risk_navigator.controller",
    "common.components.inventory.at_risk_products.at_risk_navigator.directive": "js/common/components/inventory/at_risk_products/at_risk_navigator.directive",

    "common.components.inventory.product_projection.product_projection_chart.controller": "js/common/components/inventory/product_projection/product_projection_chart.controller",
    "common.components.inventory.product_projection.product_projection_chart.directive": "js/common/components/inventory/product_projection/product_projection_chart.directive",

    "common.components.inventory.inventory_projection_tweaks.inventory_projection_tweaks.controller": "js/common/components/inventory/inventory_projection_tweaks/inventory_projection_tweaks.controller",
    "common.components.inventory.inventory_projection_tweaks.inventory_projection_tweaks.directive": "js/common/components/inventory/inventory_projection_tweaks/inventory_projection_tweaks.directive"
